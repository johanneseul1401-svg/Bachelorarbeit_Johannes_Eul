...
df_data_processed_3$Post <- as.integer(
  df_data_processed_3$Jahr > 2020 
  | (df_data_processed_3$Jahr == 2020 & df_data_processed_3$Quartal >= 1)
)
...
modelsummary(
  ...
  title = "Difference-in-Differences Regression mit Placebo Post",
  
  output = "outputs/reg_placebo.tex",
